...
yrange=range(Ahat)
xrange=range(Chl1)
plot(Ahat[1:(NR-1)],Chl1[1:(NR-1)],log='xy',type='p',pch=25,cex=1.2,lwd=2,ylim=yrange,
...
windows()
par(mfrow=c(1,1),mar=c(4,4.5,2,2)+0.1,cex.axis=1.6,cex.lab=1.8)
yrange=range(Ahat)
xrange=range(Chl1)
plot(Ahat[1:(NR-1)],Chl1[1:(NR-1)],log='xy',type='p',pch=25,cex=1.2,lwd=2,ylim=yrange,
     xlim=xrange,col='ForestGreen',xlab='Predicted Chl',
...
points(Ahat[NR:(NR+NT-2)],Chl1[NR:(NR+NT-2)],type='p',pch=17,cex=1.2,
       col='sienna')
abline(a=0,b=1,lwd=2,lty=1,col='gray')
legend('topleft',legend=c('Peter Lake','Tuesday Lake'),pch=c(25,17),
       pt.cex=c(1.2,1.2),pt.lwd=c(2,2),col=c('ForestGreen','sienna'),
       cex=1.6,bty='n')

# Plot residuals
R.err = Ahat[1:(NR-1)] - Chl1[1:(NR-1)]
T.err = Ahat[NR:(NR+NT-2)] - Chl1[NR:(NR+NT-2)]

windows(width=10,height=10)
par(mfrow=c(2,2),mar=c(4,4.5,3,2)+0.1,cex.axis=1.5,cex.lab=1.5)
acf(R.err,lag.max=14,type='correlation',plot=T,lwd=2,#xlab='',
    main='')
title('A. Residuals, Peter Lake',line=1)
acf(T.err,lag.max=14,type='correlation',plot=T,lwd=2,#xlab='',
    main='')
title('B. Residuals, Tuesday Lake',line=1)
acf(Chl1[1:(NR-1)],lag.max=14,type='correlation',plot=T,lwd=2,
    main='')
title('C. Chlorophyll, Peter Lake',line=1)
acf(Chl1[NR:(NR+NT-2)],lag.max=14,type='correlation',plot=T,lwd=2,
    main='')
title('D. Chlorophyll, Tuesday Lake',line=1)

windows()
par(mfrow=c(2,2),mar=c(4,4.5,2,2)+0.1,cex.axis=1.6,cex.lab=1.8)
plot(tplot[1:(NR-1)],R.err,type='p',pch=19,cex=1.2,col='ForestGreen',xlab='Day',
     ylab='Residual')
title('A. Residual x Day',line=1)
abline(h=0,lty=2,lwd=2,col='black')
plot(DOCvec[1:(NR-1)],R.err,type='p',pch=19,cex=1.2,col='ForestGreen',xlab='DOC',
     ylab='Residual')
title('B. Residual x DOC',line=1)
abline(h=0,lty=2,lwd=2,col='black')
plot(Ztvec[1:(NR-1)],R.err,type='p',pch=19,cex=1.2,col='ForestGreen',xlab='Thermocline',
     ylab='Residual')
title('C. Residual x Thermocline Depth',line=1)
abline(h=0,lty=2,lwd=2,col='black')
plot(ZBvec[1:(NR-1)],R.err,type='p',pch=19,cex=1.2,col='ForestGreen',xlab='Zoopl. Biom.',
     ylab='Residual')
title('D. Residual x Zooplankton Biomass',line=1)
abline(h=0,lty=2,lwd=2,col='black')

windows()
par(mfrow=c(2,2),mar=c(4,4.5,2,2)+0.1,cex.axis=1.6,cex.lab=1.8)
plot(tplot[NR:(NR+NT-2)],T.err,type='p',pch=19,cex=1.2,col='sienna',xlab='Day',
     ylab='Residual')
title('A. Residual x Day',line=1)
abline(h=0,lty=2,lwd=2,col='black')
plot(DOCvec[NR:(NR+NT-2)],T.err,type='p',pch=19,cex=1.2,col='sienna',xlab='DOC',
     ylab='Residual')
title('B. Residual x DOC',line=1)
abline(h=0,lty=2,lwd=2,col='black')
plot(Ztvec[NR:(NR+NT-2)],T.err,type='p',pch=19,cex=1.2,col='sienna',xlab='Thermocline',
     ylab='Residual')
title('C. Residual x Thermocline Depth',line=1)
abline(h=0,lty=2,lwd=2,col='black')
plot(ZBvec[NR:(NR+NT-2)],T.err,type='p',pch=19,cex=1.2,col='sienna',xlab='Zoopl. Biom.',
     ylab='Residual')
title('D. Residual x Zooplankton Biomass',line=1)
abline(h=0,lty=2,lwd=2,col='black')
...
xrange = range(Ahat)
yrange = range(c(R.err,T.err))
windows()
par(mfrow=c(1,1),mar=c(4,4.5,2,2)+0.1,cex.axis=1.6,cex.lab=1.8)
plot(Ahat[1:100],R.err,log='x',type='p',pch=25,cex=1.2,lwd=2,ylim=yrange,
     xlim=xrange,col='ForestGreen',xlab='Predicted Chlorophyll',
     ylab='Residual')
points(Ahat[101:200],T.err,type='p',pch=17,cex=1.2,
       col='sienna')
...
print(c(NLL0,NLLmod))
AICmod = 2*3 + 2*NLLmod
AIC0 =  2*1 + 2*NLL0 # sigma is the only parameter
...
# Expanded model figure for paper ================================================
m.plot = rbind(c(1,2),c(3,4),c(5,6))
print('plot layout',quote=F)
print(m.plot)

# One-step change rates
Robsrate = Chl1[1:(NR-1)]-Chl0[1:(NR-1)]
Rpredrate = Ahat[2:NR]-Chl0[1:(NR-1)]  # - Ahat[1:(NR-1)]
Tobsrate = Chl1[(NR+2):(NR+NT)]-Chl0[(NR+1):(NR+NT-1)]
Tpredrate = Ahat[(NR+2):(NR+NT)]-Chl0[(NR+1):(NR+NT-1)] #-Ahat[(NR+1):(NR+NT-1)]
#

# New Fig 2
windows(height=8,width=6)
layout(m.plot)
par(mar=c(2, 4.5, 1, 1) + 0.1,cex.axis=1.1,font.axis=2,
    cex.lab=1.4,font.lab=2,mgp=c(3,1,0))
# time series obs & predix
yrange=range(Ahat,Chl1)
plot(tplot[1:(NR-1)],Ahat[1:(NR-1)],type='l',lwd=2,col='blue',ylim=yrange,
     xlab='',ylab='Chlorophyll',main='A. Peter Lake')
points(tplot[1:(NR-1)],Chl1[1:(NR-1)],type='p',pch=19,cex=1,col='ForestGreen')
legend('topleft',legend=c('data','model'),pch=c(19,NA),lwd=c(NA,2),cex=1.5,
       col=c('Forestgreen','blue'),bty='n')
#
plot(tplot[NR:(NR+NT-2)],Ahat[NR:(NR+NT-2)],type='l',lwd=2,col='red',ylim=yrange,
     xlab='',ylab='Chlorophyll',main='B. Tuesday Lake')
points(tplot[NR:(NR+NT-2)],Chl1[NR:(NR+NT-2)],type='p',pch=19,cex=1,col='sienna')
legend('topleft',legend=c('data','model'),pch=c(19,NA),lwd=c(NA,2),cex=1.5,
       col=c('sienna','red'),bty='n')
# Time series of one-step changes
par(mar=c(4, 4.5, 1, 1) + 0.1)
yrange=range(Rpredrate,Robsrate)
plot(tplot[1:(NR-1)],Rpredrate,type='l',lwd=2,col='blue',ylim=yrange,
     xlab='Day',ylab=expression(bold(paste(Delta,' Chlorophyll')),cex=1.1),
     main='C. Peter Lake')
points(tplot[1:(NR-1)],Robsrate,type='p',pch=19,cex=1,col='ForestGreen')
#legend('topleft',legend=c('data','model'),pch=c(19,NA),lwd=c(NA,2),cex=1.5,
#       col=c('Forestgreen','blue'),bty='n')
#
yrange=range(Tpredrate,Tobsrate,na.rm=T)
plot(tplot[NR:(NR+NT-2)],Tpredrate,type='l',lwd=2,col='red',ylim=yrange,
     xlab='Day',ylab=expression(bold(paste(Delta,' Chlorophyll')),cex=1.1),
     main='D. Tuesday Lake')
points(tplot[NR:(NR+NT-2)],Tobsrate,type='p',pch=19,cex=1,col='sienna')
#legend('topleft',legend=c('data','model'),pch=c(19,NA),lwd=c(NA,2),cex=1.5,
#       col=c('sienna','red'),bty='n')
#
plot(RAgrad/CChl,Rnet,type='l',lwd=2,col='blue',
     xlab='Chlorophyll, ug/L',ylab='Growth - Grazing',
     main=paste('E.  DOC = ',round(RDOCf,1),', P load = ',3) )
abline(h=0,lty=3,lwd=2)
points(Req.chl,c(0,0,0),type='p',pch=c(19,21,19),lwd=2,cex=2.5,col='black')
#
plot(TAgrad/CChl,Tnet,type='l',lwd=2,col='blue',
     xlab='Chlorophyll, ug/L',ylab='Growth - Grazing',
     main=paste('F.  DOC = ',round(TDOCf,1),', P load = ',3) )
abline(h=0,lty=3,lwd=2)
points(Teq.chl,c(0,0,0),type='p',pch=c(19,21,19),lwd=2,cex=2.5,col='black')

# New Fig 2, Alternate lettering
windows(height=8,width=6)
layout(m.plot)
par(mar=c(2, 4.5, 1, 1) + 0.1,cex.axis=1.1,font.axis=2,
    cex.lab=1.4,font.lab=2,mgp=c(3,1,0))
...
yrange=range(Ahat,Chl1)
plot(tplot[1:(NR-1)],Ahat[1:(NR-1)],type='l',lwd=2,col='blue',ylim=yrange,
     xlab='',ylab='Chlorophyll',main='Peter Lake')
points(tplot[1:(NR-1)],Chl1[1:(NR-1)],type='p',pch=19,cex=1,col='ForestGreen')
legend('topleft',legend=c('data','model'),pch=c(19,NA),lwd=c(NA,2),cex=1.5,
       col=c('Forestgreen','blue'),title='A',title.adj=0.1,bty='n')
#
plot(tplot[NR:(NR+NT-2)],Ahat[NR:(NR+NT-2)],type='l',lwd=2,col='red',ylim=yrange,
     xlab='',ylab='Chlorophyll',main='Tuesday Lake')
points(tplot[NR:(NR+NT-2)],Chl1[NR:(NR+NT-2)],type='p',pch=19,cex=1,col='sienna')
legend('topleft',legend=c('data','model'),pch=c(19,NA),lwd=c(NA,2),cex=1.5,
       col=c('sienna','red'),title='B',title.adj=0.1,bty='n')
#
# Time series of one-step changes
par(mar=c(4, 4.5, 1, 1) + 0.1)
yrange=range(Rpredrate,Robsrate)
plot(tplot[1:(NR-1)],Rpredrate,type='l',lwd=2,col='blue',ylim=yrange,
     xlab='Day',ylab=expression(bold(paste(Delta,' Chlorophyll')),cex=1.1))#,main='C. Peter Lake')
points(tplot[1:(NR-1)],Robsrate,type='p',pch=19,cex=1,col='ForestGreen')
text(150,10,'C',cex=1.5)
#legend('topleft',legend=c('data','model'),pch=c(19,NA),lwd=c(NA,2),cex=1.5,
#       col=c('Forestgreen','blue'),bty='n')
#
yrange=range(Tpredrate,Tobsrate,na.rm=T)
plot(tplot[NR:(NR+NT-2)],Tpredrate,type='l',lwd=2,col='red',ylim=yrange,
     xlab='Day',ylab=expression(bold(paste(Delta,' Chlorophyll')),cex=1.1))#,main='D. Tuesday Lake')
points(tplot[NR:(NR+NT-2)],Tobsrate,type='p',pch=19,cex=1,col='sienna')
text(150,18,'D',cex=1.5)
#legend('topleft',legend=c('data','model'),pch=c(19,NA),lwd=c(NA,2),cex=1.5,
#       col=c('sienna','red'),bty='n')
#
plot(RAgrad/CChl,Rnet,type='l',lwd=2,col='blue',
